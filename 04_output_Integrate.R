...
IndsPCArea<-c("Area","Residential_1","Agriculture_2.1","Agriculture_2.3a","Agriculture_2all","Transport_4.1","Transport_4all","BioUse_5.1a","BioUse_5.3","HumanIntrusion_6")
